vidPath= "/home/dyno/Downloads/Benefit_of_Distraction-master/Data/video_Benefit_of_distraction.mov"; % please provide a video path after downloading a dataset
load('/home/dyno/Downloads/Benefit_of_Distraction-master/Benefit_of_Distraction/Data/sample_mask_noise.mat') 
...
save('/home/dyno/Downloads/Benefit_of_Distraction-master/Benefit_of_Distraction/Data/sample_mask_noise_new.mat',  'mask_noise', '-v7.3') 

%% use the mask_noise to create the red, green and channel noise estimates
load('/home/dyno/Downloads/Benefit_of_Distraction-master/Benefit_of_Distraction/Data/sample_yptest.mat') % predicted BR or HR signal
...
%         vidLxL = imresize(im2single(vidFrame(:,Width/2-Height/2+1:Width/2+Height/2,:)),[L,L]);
    ...
    if RGB_channel == 1
        ...
        save('/home/dyno/Downloads/Benefit_of_Distraction-master/Benefit_of_Distraction/Data/RGB_noise_estimates_red/sample_noise_new.mat', 'yptest', 'yptest_sub2', 'mask_noise_red', 'mask_noise_red_mean', 'mask_noise_red_mean2', '-v7.3');
    ...
    elseif RGB_channel == 2
        ...
        save('/home/dyno/Downloads/Benefit_of_Distraction-master/Benefit_of_Distraction/Data/RGB_noise_estimates_green/sample_noise_new.mat', 'yptest', 'yptest_sub2', 'mask_noise_green', 'mask_noise_green_mean', 'mask_noise_green_mean2', '-v7.3');

    elseif RGB_channel == 3
        mask_noise_blue = mask_noise_channel;
        mask_noise_green_mean = mask_noise_channel_mean;
        mask_noise_green_mean2 = mask_noise_channel_mean2;
        save('/home/dyno/Downloads/Benefit_of_Distraction-master/Benefit_of_Distraction/Data/RGB_noise_estimates_blue/sample_noise_new.mat', 'yptest', 'yptest_sub2', 'mask_noise_blue', 'mask_noise_blue_mean', 'mask_noise_blue_mean2', '-v7.3');
    end    
end